...
def _perfect_perspective_kernel(
    img,
    h,
    w,
    fov_angle,
...
class PerfectPerspectiveFilter(BaseFilter):
    def __init__(self):
        ...
        self.vignette_intensity = (
            0.0  # Default 1.0 in shader, but usually 0 is better for default
        )
    ...
    def apply(self, image: np.ndarray, **params) -> np.ndarray:
        ...
        self.vignette_intensity = float(
            params.get("VignetteIntensity", self.vignette_intensity)
        )
